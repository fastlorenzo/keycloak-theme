  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        <img src="${resourcesPath}/img/logo_only.svg" alt="${productName}" border="0" />
...
${adminUserCreationMessage}.
        ...
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-m">
            <h3><a href="/realms/master/account/"><img src="welcome-content/keycloak-project.png">My account <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
          </div>
